...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  try {
    ...
    const sgPayload = {
      ...
      template_id: process.env.SENDGRID_TEMPLATE_ID_RU || 'd-cb881e00e3f04d1faa169fe4656fc84',
    };
